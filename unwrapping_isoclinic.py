...
def phase_unwrap_isoclinic(img: np.ndarray, stack, center, radius) -> np.ndarray:
    """
...
if __name__ == "__main__":
    ...
    # stack = [(2600,3500), (1000, 2400)]
    stack = [(center[1], center[0] - r), (center[1], center[0] + r)]

    img_unwrapped = phase_unwrap_isoclinic(img, stack, center, r)
    # img_unwrapped = np.unwrap(mask_circ_img(img, center, r), period=255)

    plt.imsave('isoclinic_unwrapped.jpg', img_unwrapped, cmap='gray')
